...
// 	protoc        v7.34.0
// source: protos/external/goval/api/signing.proto
...
func (TokenVersion) Descriptor() protoreflect.EnumDescriptor {
	return file_protos_external_goval_api_signing_proto_enumTypes[0].Descriptor()
}

func (TokenVersion) Type() protoreflect.EnumType {
	return &file_protos_external_goval_api_signing_proto_enumTypes[0]
}
...
func (TokenVersion) EnumDescriptor() ([]byte, []int) {
	return file_protos_external_goval_api_signing_proto_rawDescGZIP(), []int{0}
}
...
const (
	...
	FlagClaim_DEPLOYMENTS FlagClaim = 10
	...
	FlagClaim_ANY_USER_ID FlagClaim = 11
	...
	FlagClaim_ANY_ORG FlagClaim = 12
	// Cert has the authority to sign identity messages with any Repl creation
	// timestamp.
...
func (FlagClaim) Descriptor() protoreflect.EnumDescriptor {
	return file_protos_external_goval_api_signing_proto_enumTypes[1].Descriptor()
}

func (FlagClaim) Type() protoreflect.EnumType {
	return &file_protos_external_goval_api_signing_proto_enumTypes[1]
}
...
func (FlagClaim) EnumDescriptor() ([]byte, []int) {
	return file_protos_external_goval_api_signing_proto_rawDescGZIP(), []int{1}
}

// Organization type. There are legacy types, but we are not
// supporting them, and they should not be getting passed.
type Org_OrgType int32

const (
	Org_TYPE_UNSPECIFIED Org_OrgType = 0
	Org_PERSONAL         Org_OrgType = 1
	Org_TEAM             Org_OrgType = 2
)

// Enum value maps for Org_OrgType.
var (
	Org_OrgType_name = map[int32]string{
		0: "TYPE_UNSPECIFIED",
		1: "PERSONAL",
		2: "TEAM",
	}
	Org_OrgType_value = map[string]int32{
		"TYPE_UNSPECIFIED": 0,
		"PERSONAL":         1,
		"TEAM":             2,
	}
...
func (x Org_OrgType) Enum() *Org_OrgType {
	p := new(Org_OrgType)
	*p = x
	return p
}

func (x Org_OrgType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (Org_OrgType) Descriptor() protoreflect.EnumDescriptor {
	return file_protos_external_goval_api_signing_proto_enumTypes[2].Descriptor()
}

func (Org_OrgType) Type() protoreflect.EnumType {
	return &file_protos_external_goval_api_signing_proto_enumTypes[2]
}

func (x Org_OrgType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use Org_OrgType.Descriptor instead.
func (Org_OrgType) EnumDescriptor() ([]byte, []int) {
	return file_protos_external_goval_api_signing_proto_rawDescGZIP(), []int{9, 0}
}
...
func (x *GovalSigningAuthority) Reset() {
	*x = GovalSigningAuthority{}
	if protoimpl.UnsafeEnabled {
		mi := &file_protos_external_goval_api_signing_proto_msgTypes[0]
...
func (x *CertificateClaim) Reset() {
	*x = CertificateClaim{}
	if protoimpl.UnsafeEnabled {
		mi := &file_protos_external_goval_api_signing_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (x *CertificateClaim) GetUserId() int64 {
	if x, ok := x.GetClaim().(*CertificateClaim_UserId); ok {
		return x.UserId
	}
	return 0
}

func (x *CertificateClaim) GetOrg() *Org {
	if x, ok := x.GetClaim().(*CertificateClaim_Org); ok {
		return x.Org
	}
	return nil
}
...
func (x *CertificateClaim) GetDeployment() bool {
	if x, ok := x.GetClaim().(*CertificateClaim_Deployment); ok {
		return x.Deployment
	}
	return false
}
...
func (x *CertificateClaim) GetReplCreatedAt() *timestamppb.Timestamp {
	if x, ok := x.GetClaim().(*CertificateClaim_ReplCreatedAt); ok {
		return x.ReplCreatedAt
	}
	return nil
}
...
type CertificateClaim_UserId struct {
	// This cert has the authority to sign messages on behalf of a user id
	UserId int64 `protobuf:"varint,7,opt,name=user_id,json=userId,proto3,oneof"`
}

type CertificateClaim_Org struct {
	// This cert has the authority to sign messages on behalf of an org
	Org *Org `protobuf:"bytes,8,opt,name=org,proto3,oneof"`
}
...
type CertificateClaim_Deployment struct {
	// This cert has the authority to sign messages that claim to come from a
	// deployment.
	Deployment bool `protobuf:"varint,6,opt,name=deployment,proto3,oneof"`
}
...
type CertificateClaim_ReplCreatedAt struct {
	// This cert has the authority to sign identity messages with this Repl
	// creation timestamp.
...
func (*CertificateClaim_UserId) isCertificateClaim_Claim() {}

func (*CertificateClaim_Org) isCertificateClaim_Claim() {}

func (*CertificateClaim_Cluster) isCertificateClaim_Claim() {}

func (*CertificateClaim_Subcluster) isCertificateClaim_Claim() {}

func (*CertificateClaim_Deployment) isCertificateClaim_Claim() {}

func (*CertificateClaim_Flag) isCertificateClaim_Claim() {}

func (*CertificateClaim_ReplCreatedAt) isCertificateClaim_Claim() {}
...
func (x *GovalCert) Reset() {
	*x = GovalCert{}
	if protoimpl.UnsafeEnabled {
		mi := &file_protos_external_goval_api_signing_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GovalCert) Descriptor() ([]byte, []int) {
	return file_protos_external_goval_api_signing_proto_rawDescGZIP(), []int{2}
}

func (x *GovalCert) GetIat() *timestamppb.Timestamp {
	if x != nil {
		return x.Iat
	}
	return nil
...
func (x *GovalCert) GetExp() *timestamppb.Timestamp {
	if x != nil {
		return x.Exp
	}
	return nil
...
func (x *GovalToken) Reset() {
	*x = GovalToken{}
	if protoimpl.UnsafeEnabled {
		mi := &file_protos_external_goval_api_signing_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GovalToken) Descriptor() ([]byte, []int) {
	return file_protos_external_goval_api_signing_proto_rawDescGZIP(), []int{3}
}

func (x *GovalToken) GetIat() *timestamppb.Timestamp {
	if x != nil {
		return x.Iat
	}
	return nil
...
func (x *GovalToken) GetExp() *timestamppb.Timestamp {
	if x != nil {
		return x.Exp
	}
	return nil
...
type GovalReplIdentity struct {
	...
	// The time at which the Repl was created.
...
func (x *GovalReplIdentity) Reset() {
	*x = GovalReplIdentity{}
	if protoimpl.UnsafeEnabled {
		mi := &file_protos_external_goval_api_signing_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GovalReplIdentity) Descriptor() ([]byte, []int) {
	return file_protos_external_goval_api_signing_proto_rawDescGZIP(), []int{4}
}
...
func (x *GovalReplIdentity) GetHosting() *ReplRuntimeHosting {
	if x, ok := x.GetRuntime().(*GovalReplIdentity_Hosting); ok {
		return x.Hosting
	}
	return nil
}
...
func (x *GovalReplIdentity) GetOrg() *Org {
	if x != nil {
		return x.Org
	}
	return nil
...
func (x *GovalReplIdentity) GetReplCreatedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.ReplCreatedAt
	}
	return nil
...
type GovalReplIdentity_Hosting struct {
	// This is set if the Repl is running in a hosting subcluster.
	Hosting *ReplRuntimeHosting `protobuf:"bytes,13,opt,name=hosting,proto3,oneof"`
}
...
func (*GovalReplIdentity_Hosting) isGovalReplIdentity_Runtime() {}
...
func (x *BuildInfo) Reset() {
	*x = BuildInfo{}
	if protoimpl.UnsafeEnabled {
		mi := &file_protos_external_goval_api_signing_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*BuildInfo) Descriptor() ([]byte, []int) {
	return file_protos_external_goval_api_signing_proto_rawDescGZIP(), []int{5}
}
...
func (x *ReplRuntimeInteractive) Reset() {
	*x = ReplRuntimeInteractive{}
	if protoimpl.UnsafeEnabled {
		mi := &file_protos_external_goval_api_signing_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ReplRuntimeInteractive) Descriptor() ([]byte, []int) {
	return file_protos_external_goval_api_signing_proto_rawDescGZIP(), []int{6}
}
...
type ReplRuntimeHosting struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *ReplRuntimeHosting) Reset() {
	*x = ReplRuntimeHosting{}
	if protoimpl.UnsafeEnabled {
		mi := &file_protos_external_goval_api_signing_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *ReplRuntimeHosting) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ReplRuntimeHosting) ProtoMessage() {}

func (x *ReplRuntimeHosting) ProtoReflect() protoreflect.Message {
	mi := &file_protos_external_goval_api_signing_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ReplRuntimeHosting.ProtoReflect.Descriptor instead.
func (*ReplRuntimeHosting) Descriptor() ([]byte, []int) {
	return file_protos_external_goval_api_signing_proto_rawDescGZIP(), []int{7}
}

func (x *ReplRuntimeHosting) GetCluster() string {
	if x != nil {
		return x.Cluster
	}
	return ""
...
func (x *ReplRuntimeHosting) GetSubcluster() string {
	if x != nil {
		return x.Subcluster
	}
	return ""
...
func (x *ReplRuntimeDeployment) Reset() {
	*x = ReplRuntimeDeployment{}
	if protoimpl.UnsafeEnabled {
		mi := &file_protos_external_goval_api_signing_proto_msgTypes[8]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ReplRuntimeDeployment) Descriptor() ([]byte, []int) {
	return file_protos_external_goval_api_signing_proto_rawDescGZIP(), []int{8}
}
...
type Org struct {
	...
	Type Org_OrgType `protobuf:"varint,2,opt,name=type,proto3,enum=api.Org_OrgType" json:"type,omitempty"`
}

func (x *Org) Reset() {
	*x = Org{}
	if protoimpl.UnsafeEnabled {
		mi := &file_protos_external_goval_api_signing_proto_msgTypes[9]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Org) Descriptor() ([]byte, []int) {
	return file_protos_external_goval_api_signing_proto_rawDescGZIP(), []int{9}
}
...
func (x *Org) GetType() Org_OrgType {
	if x != nil {
		return x.Type
	}
...
var File_protos_external_goval_api_signing_proto protoreflect.FileDescriptor

var file_protos_external_goval_api_signing_proto_rawDesc = []byte{
	,
	...
	,
}

var (
	file_protos_external_goval_api_signing_proto_rawDescOnce sync.Once
	file_protos_external_goval_api_signing_proto_rawDescData = file_protos_external_goval_api_signing_proto_rawDesc
)

func file_protos_external_goval_api_signing_proto_rawDescGZIP() []byte {
	file_protos_external_goval_api_signing_proto_rawDescOnce.Do(func() {
		file_protos_external_goval_api_signing_proto_rawDescData = protoimpl.X.CompressGZIP(file_protos_external_goval_api_signing_proto_rawDescData)
	})
	return file_protos_external_goval_api_signing_proto_rawDescData
}

var file_protos_external_goval_api_signing_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var file_protos_external_goval_api_signing_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_protos_external_goval_api_signing_proto_goTypes = []interface{}{
	(TokenVersion)(0),              // 0: api.TokenVersion
	(FlagClaim)(0),                 // 1: api.FlagClaim
	(Org_OrgType)(0),               // 2: api.Org.OrgType
	(*GovalSigningAuthority)(nil),  // 3: api.GovalSigningAuthority
	(*CertificateClaim)(nil),       // 4: api.CertificateClaim
	(*GovalCert)(nil),              // 5: api.GovalCert
	(*GovalToken)(nil),             // 6: api.GovalToken
	(*GovalReplIdentity)(nil),      // 7: api.GovalReplIdentity
	(*BuildInfo)(nil),              // 8: api.BuildInfo
	(*ReplRuntimeInteractive)(nil), // 9: api.ReplRuntimeInteractive
	(*ReplRuntimeHosting)(nil),     // 10: api.ReplRuntimeHosting
	(*ReplRuntimeDeployment)(nil),  // 11: api.ReplRuntimeDeployment
	(*Org)(nil),                    // 12: api.Org
	(*timestamppb.Timestamp)(nil),  // 13: google.protobuf.Timestamp
	(*ReplToken)(nil),              // 14: api.ReplToken
}
var file_protos_external_goval_api_signing_proto_depIdxs = []int32{
	0,  // 0: api.GovalSigningAuthority.version:type_name -> api.TokenVersion
	12, // 1: api.CertificateClaim.org:type_name -> api.Org
	1,  // 2: api.CertificateClaim.flag:type_name -> api.FlagClaim
	13, // 3: api.CertificateClaim.repl_created_at:type_name -> google.protobuf.Timestamp
	13, // 4: api.GovalCert.iat:type_name -> google.protobuf.Timestamp
	13, // 5: api.GovalCert.exp:type_name -> google.protobuf.Timestamp
	4,  // 6: api.GovalCert.claims:type_name -> api.CertificateClaim
	13, // 7: api.GovalToken.iat:type_name -> google.protobuf.Timestamp
	13, // 8: api.GovalToken.exp:type_name -> google.protobuf.Timestamp
	14, // 9: api.GovalToken.repl_token:type_name -> api.ReplToken
	7,  // 10: api.GovalToken.repl_identity:type_name -> api.GovalReplIdentity
	8,  // 11: api.GovalReplIdentity.build_info:type_name -> api.BuildInfo
	9,  // 12: api.GovalReplIdentity.interactive:type_name -> api.ReplRuntimeInteractive
	10, // 13: api.GovalReplIdentity.hosting:type_name -> api.ReplRuntimeHosting
	11, // 14: api.GovalReplIdentity.deployment:type_name -> api.ReplRuntimeDeployment
	12, // 15: api.GovalReplIdentity.org:type_name -> api.Org
	13, // 16: api.GovalReplIdentity.repl_created_at:type_name -> google.protobuf.Timestamp
	2,  // 17: api.Org.type:type_name -> api.Org.OrgType
...
func init() { file_protos_external_goval_api_signing_proto_init() }
func file_protos_external_goval_api_signing_proto_init() {
	if File_protos_external_goval_api_signing_proto != nil {
		return
	}
	file_protos_external_goval_api_client_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_protos_external_goval_api_signing_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_protos_external_goval_api_signing_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_protos_external_goval_api_signing_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_protos_external_goval_api_signing_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_protos_external_goval_api_signing_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_protos_external_goval_api_signing_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_protos_external_goval_api_signing_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_protos_external_goval_api_signing_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ReplRuntimeHosting); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_protos_external_goval_api_signing_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
		...
		file_protos_external_goval_api_signing_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Org); i {
			case 0:
				return &v.state
			case 1:
	...
	file_protos_external_goval_api_signing_proto_msgTypes[0].OneofWrappers = []interface{}{
		(*GovalSigningAuthority_KeyId)(nil),
		(*GovalSigningAuthority_SignedCert)(nil),
	}
	file_protos_external_goval_api_signing_proto_msgTypes[1].OneofWrappers = []interface{}{
		(*CertificateClaim_Replid)(nil),
		(*CertificateClaim_User)(nil),
		(*CertificateClaim_UserId)(nil),
		(*CertificateClaim_Org)(nil),
		(*CertificateClaim_Cluster)(nil),
		(*CertificateClaim_Subcluster)(nil),
		(*CertificateClaim_Deployment)(nil),
		(*CertificateClaim_Flag)(nil),
		(*CertificateClaim_ReplCreatedAt)(nil),
	}
	file_protos_external_goval_api_signing_proto_msgTypes[3].OneofWrappers = []interface{}{
		(*GovalToken_ReplToken)(nil),
		(*GovalToken_ReplIdentity)(nil),
	}
	file_protos_external_goval_api_signing_proto_msgTypes[4].OneofWrappers = []interface{}{
		(*GovalReplIdentity_Interactive)(nil),
		(*GovalReplIdentity_Hosting)(nil),
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_protos_external_goval_api_signing_proto_rawDesc,
			NumEnums:      3,
			NumMessages:   10,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_protos_external_goval_api_signing_proto_goTypes,
		DependencyIndexes: file_protos_external_goval_api_signing_proto_depIdxs,
		EnumInfos:         file_protos_external_goval_api_signing_proto_enumTypes,
		MessageInfos:      file_protos_external_goval_api_signing_proto_msgTypes,
	}.Build()
	File_protos_external_goval_api_signing_proto = out.File
	file_protos_external_goval_api_signing_proto_rawDesc = nil
	file_protos_external_goval_api_signing_proto_goTypes = nil
	file_protos_external_goval_api_signing_proto_depIdxs = nil
}
