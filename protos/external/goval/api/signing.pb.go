...
type Org struct {
	...
	Slug  string                 `protobuf:"bytes,3,opt,name=slug,proto3" json:"slug,omitempty"`
	// Whether this org has an enterprise deal
...
func (x *Org) GetIsEnterprise() bool {
	if x != nil {
...
const file_protos_external_goval_api_signing_proto_rawDesc = "" +
	...
	"deployment\x12$\n" +
	"\x04flag\x18\x03 \x01(\x0e2\x0e.api.FlagClaimH\x00R\x04flagB\a\n" +
	"\x05claim\"\xb4\x01\n" +
	"\tGovalCert\x12,\n" +
	...
	"deployment\x12\x1a\n" +
	"\x03org\x18\x0e \x01(\v2\b.api.OrgR\x03orgB\t\n" +
	"\aruntime\"\x80\x01\n" +
	"\tBuildInfo\x12#\n" +
	...
	"subcluster\x18\x02 \x01(\tR\n" +
	"subcluster\"\x17\n" +
	"\x15ReplRuntimeDeployment\"\xad\x01\n" +
	"\x03Org\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12$\n" +
	"\x04type\x18\x02 \x01(\x0e2\x10.api.Org.OrgTypeR\x04type\x12\x12\n" +
	"\x04slug\x18\x03 \x01(\tR\x04slug\x12#\n" +
	"\ris_enterprise\x18\x04 \x01(\bR\fisEnterprise\"7\n" +
	"\aOrgType\x12\x14\n" +
	...
	"\x10TYPE_AWARE_TOKEN\x10\x01*\xf0\x01\n" +
	"\tFlagClaim\x12\x14\n" +
	...
	"\x0eANY_SUBCLUSTER\x10\tB=Z;github.com/replit/go-replidentity/protos/external/goval/apib\x06proto3"
