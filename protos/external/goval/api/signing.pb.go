...
func (x *GovalSigningAuthority) GetCert() isGovalSigningAuthority_Cert {
	if x != nil {
		return x.Cert
	}
	return nil
...
func (x *GovalSigningAuthority) GetKeyId() string {
	if x != nil {
		if x, ok := x.Cert.(*GovalSigningAuthority_KeyId); ok {
			return x.KeyId
		}
	}
	return ""
...
func (x *GovalSigningAuthority) GetSignedCert() string {
	if x != nil {
		if x, ok := x.Cert.(*GovalSigningAuthority_SignedCert); ok {
			return x.SignedCert
		}
	}
	return ""
...
func (x *CertificateClaim) GetClaim() isCertificateClaim_Claim {
	if x != nil {
		return x.Claim
	}
	return nil
...
func (x *CertificateClaim) GetReplid() string {
	if x != nil {
		if x, ok := x.Claim.(*CertificateClaim_Replid); ok {
			return x.Replid
		}
	}
	return ""
...
func (x *CertificateClaim) GetUser() string {
	if x != nil {
		if x, ok := x.Claim.(*CertificateClaim_User); ok {
			return x.User
		}
	}
	return ""
...
func (x *CertificateClaim) GetUserId() int64 {
	if x != nil {
		if x, ok := x.Claim.(*CertificateClaim_UserId); ok {
			return x.UserId
		}
	}
	return 0
...
func (x *CertificateClaim) GetOrg() *Org {
	if x != nil {
		if x, ok := x.Claim.(*CertificateClaim_Org); ok {
			return x.Org
		}
	}
	return nil
...
func (x *CertificateClaim) GetCluster() string {
	if x != nil {
		if x, ok := x.Claim.(*CertificateClaim_Cluster); ok {
			return x.Cluster
		}
	}
	return ""
...
func (x *CertificateClaim) GetSubcluster() string {
	if x != nil {
		if x, ok := x.Claim.(*CertificateClaim_Subcluster); ok {
			return x.Subcluster
		}
	}
	return ""
...
func (x *CertificateClaim) GetDeployment() bool {
	if x != nil {
		if x, ok := x.Claim.(*CertificateClaim_Deployment); ok {
			return x.Deployment
		}
	}
	return false
...
func (x *CertificateClaim) GetFlag() FlagClaim {
	if x != nil {
		if x, ok := x.Claim.(*CertificateClaim_Flag); ok {
			return x.Flag
		}
	}
...
func (x *CertificateClaim) GetReplCreatedAt() *timestamppb.Timestamp {
	if x != nil {
		if x, ok := x.Claim.(*CertificateClaim_ReplCreatedAt); ok {
...
func (x *GovalToken) GetToken() isGovalToken_Token {
	if x != nil {
		return x.Token
	}
	return nil
...
func (x *GovalToken) GetReplToken() *ReplToken {
	if x != nil {
		if x, ok := x.Token.(*GovalToken_ReplToken); ok {
			return x.ReplToken
		}
	}
	return nil
...
func (x *GovalToken) GetReplIdentity() *GovalReplIdentity {
	if x != nil {
		if x, ok := x.Token.(*GovalToken_ReplIdentity); ok {
...
func (x *GovalReplIdentity) GetRuntime() isGovalReplIdentity_Runtime {
	if x != nil {
		return x.Runtime
	}
	return nil
...
func (x *GovalReplIdentity) GetInteractive() *ReplRuntimeInteractive {
	if x != nil {
		if x, ok := x.Runtime.(*GovalReplIdentity_Interactive); ok {
...
func (x *GovalReplIdentity) GetHosting() *ReplRuntimeHosting {
	if x != nil {
		if x, ok := x.Runtime.(*GovalReplIdentity_Hosting); ok {
			return x.Hosting
		}
	}
	return nil
...
func (x *GovalReplIdentity) GetDeployment() *ReplRuntimeDeployment {
	if x != nil {
		if x, ok := x.Runtime.(*GovalReplIdentity_Deployment); ok {
			return x.Deployment
		}
	}
	return nil
...
const file_protos_external_goval_api_signing_proto_rawDesc = "" +
	"\n" +
	...
	"\x13ANY_REPL_CREATED_AT\x10\rB=Z;github.com/replit/go-replidentity/protos/external/goval/apib\x06proto3"

var (
	file_protos_external_goval_api_signing_proto_rawDescOnce sync.Once
	file_protos_external_goval_api_signing_proto_rawDescData []byte
)
...
func file_protos_external_goval_api_signing_proto_rawDescGZIP() []byte {
	file_protos_external_goval_api_signing_proto_rawDescOnce.Do(func() {
		file_protos_external_goval_api_signing_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_protos_external_goval_api_signing_proto_rawDesc), len(file_protos_external_goval_api_signing_proto_rawDesc)))
	})
...
var file_protos_external_goval_api_signing_proto_goTypes = []any{
...
func file_protos_external_goval_api_signing_proto_init() {
	...
	file_protos_external_goval_api_signing_proto_msgTypes[0].OneofWrappers = []any{
		(*GovalSigningAuthority_KeyId)(nil),
		(*GovalSigningAuthority_SignedCert)(nil),
	}
	file_protos_external_goval_api_signing_proto_msgTypes[1].OneofWrappers = []any{
	...
	file_protos_external_goval_api_signing_proto_msgTypes[3].OneofWrappers = []any{
		(*GovalToken_ReplToken)(nil),
		(*GovalToken_ReplIdentity)(nil),
	}
	file_protos_external_goval_api_signing_proto_msgTypes[4].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_protos_external_goval_api_signing_proto_rawDesc), len(file_protos_external_goval_api_signing_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   10,
			NumExtensions: 0,
			NumServices:   0,
